...
if (instance_position(nearest_attack_square.x-32, nearest_attack_square.y+32, obj_move_square)) {dist4 = point_distance(global.selected.x, global.selected.y, nearest_attack_square.x-32, nearest_attack_square.y+32);}
else {dist4 = 10000;}
